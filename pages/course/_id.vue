      ...
      <div>
        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section
              v-if="isbuyCourse || Number(courseInfo.price) === 0"
              class="c-attr-mt"
            >
...
export default {
  ...
  asyncData({ params, error }) {
    return course.getMinuteCourseInfo(params.id).then((response) => {
      return {
        courseId: params.id,
  ...
  methods: {
    ...
    //获取课程详情
    initCourseInfo() {
      course.getMinuteCourseInfo(this.courseId).then((response) => {
